...
es.room {
    ...
    pic = "station/dock",
    disp = "Пирс",
    dsc = [[Я мечусь у пристани, как искринка пыли в броуновском движении. Скафандр неприятно поскрипывает при каждом шаге.]],
    enter = function(s)
        if not s.mus then
            s.mus = true
...
es.obj {
    ...
    act = "Надеюсь, официальная процедура приветствия скоро завершится, и нам покажут наши жилые модули."
}
...
es.obj {
    nam = "vera",
    cnd = "{grigoriev}.done and {majorov}.done",
    dsc = "{Девушка} сиротливо стоит у стены и с любопытством поглядывает на мой скафандр.",
    act = function(s)
