...
es.room {
    ...
    ^Сначала втираю в себя щелочной порошок, отдающий бытовой хлоркой -- так рьяно, словно хочу сжечь кожу, -- а потом долго стою под струёй затхлого воздуха.
...
es.room {
    ...
    pic = "ship/corridor",
    disp = "Коридор",
    dsc = [[На полу коридора осталось несколько красных пятен. Я стараюсь не смотреть на них.]],
    enter = function(s)
        if not s.mus then
            s.mus = true
...
es.room {
    ...
    pic = "ship/deck",
    disp = "Рубка",
    dsc = [[Кажется, что ничего не произошло -- капитан заканчивает вахту, я только что проснулся от изматывающего сна, остальной экипаж отдыхает в каютах.]],
    obj = { "majorov3" },
    way = {
        path { "В коридор", "ship4" }
    }
