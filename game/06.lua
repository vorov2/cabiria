...
es.obj {
    nam = "dreams",
    dsc = "Наверное, когда прекратятся кошмары с мерзкими алыми червями, пожирающими меня живьём, как труп, им на смену придут новые сны -- и я начну блуждать по таким вот сумрачным {лабиринтам} в поисках света в конце тоннеля.",
