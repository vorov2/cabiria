...
es.obj {
    ...
    ^Описания интерактивных предметов всегда выводятся в область общего описания сцены. Если вы хотите вернуть общее описание, щёлкните на названии сцены над иллюстрацией.]],
    used = function(s, w)
        if w.nam == "box" then
...
es.obj {
    ...
    act = function(s)
        ...
        if not s.done then
            s.done = true
            return [[Вы берёте со стола шкатулку. Обратите внимание, теперь она у вас в инвентаре, в списке в правой части экрана.
