...
es.obj {
    ...
    dsc = "Я стою в жилом блоке напротив двери в модуль Майорова. Нужно лишь протянуть руку и нажать на {кнопку} звонка.",
    act = function(s)
        if not s.done then
            s.done = true
...
es.room {
    ...
    dsc = [[Потрескивает проводка, сыплются искры с потолка. Пол качается под ногами, как на корабле в шторм. В ушах стоит дикий звон, словно кто-то врубил тревожный сигнал прямо у меня в черепной коробке. Мысли путаются. Я делаю несколько шагов и приваливаюсь плечом к переборке.]],
    enter = function(s)
