...
es.room {
    ...
    ^Я что-то говорю ему, но слова как-то путаются, цепляются друг за друга, утрачивая даже тень смысла. Я говорю долго -- так, по крайней мере, кажется. Я всё пытаюсь ему что-то объяснить, втолковываю про операционные модули, нуболидов, прочность камеры содержания. 
    ^Он не отвечает.
...
es.room {
    ...
    pic = "station/impact5",
    disp = "Коридор",
    dsc = [[С потолка что-то сыплется, как град. Я невольно прикрываю голову. Раздаётся мелодичный голос системы оповещения:
...
es.room {
    ...
    pic = "station/impact6",
    disp = "Коридор",
    dsc = [[Кто-то подхватывает меня под руки. Я не сопротивляюсь. Мне хочется сказать, что я ещё жив, но я не могу разлепить рот. Наверное, сейчас меня потащат в красное марево, как другие трупы.
