...
es.obj {
    nam = "destruction",
    dsc = "Пару ламп полопалась. Судя по подпалинам на потолке, небольшие {возгорания} были и в рубке.",
...
es.room {
    ...
    dsc = [[Разрушений у лестничной клетки меньше, но с потолка, сквозь длинные, точно прорезанные автогеном щели, всё равно свисает проводка. Пару ламп чудом горит, подкрашивая багрянцем стены.]],
