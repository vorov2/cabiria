...
es.room {
    ...
    noinv = true,
    pic = "dream/beach.sky",
    dsc = [[День такой жаркий, что в городе находиться невозможно. Кажется, что кожа плавится от духоты. Хорошо хоть, что мы с Верой можем выбраться на пляж.
...
es.room {
    ...
    pic = "dream/beach.shore",
    disp = "Пляж",
    dsc = [[Ветер приятно холодит нагревшуюся кожу. Я закрываю глаза и подставляю лицо ласковому озёрному бризу.]],
    onexit = function(s, t)
...
es.obj {
    ...
    dsc = "{Волны} накатывают на песок, утаскивая в зеленоватые воды мелкие камешки и битые ракушки.",
    act = function(s)
        walkin("pause2")
        return true
    end
