...
es.room {
    ...
    disp = "Пляж",
    dsc = [[Как ни странно, на пляже никого, кроме нас нет, хотя при такой погоде только и думаешь о том, ак бы найти спасения у воды.]],
    onexit = function(s, t)
...
es.obj {
    ...
    inv = function(s)
        ...
        if not s.unbar then
            s.unbar = true
            return [[Фиксатор на стержне зонта впивается мне в палец, и я поднимаю на удивление тугой бегунок, раскрывая широкий сине-белый купол, яркий, как детская игрушка.
