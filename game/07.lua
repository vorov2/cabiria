...
es.obj {
    ...
    act = function(s)
        ...
        elseif not s.taken and not have("breakfast") and all.vending.drink then
            return "Только напитка для завтрака будет мало."
...
es.room {
    ...
    effects = {
        ["1x0"] = nil,
        ["2x0"] = "Нуболиды необычно сгруппировались, как будто камера стала меньше, и напоминают теперь плотные заросли ламинариев.",
        ...
        ["3x1"] = nil,
        ["0x2"] = nil,
        ["1x2"] = "Нуболиды облепили стёкла камеры, как будто что-то выталкивает их наружу, и теперь до отвращения напоминают ленточных червей.",
        ["2x2"] = nil,
        ...
        ["1x3"] = "Нуболиды летают по камере, иногда сплетаюся вместе и образуют дёргающие, как при агонии, конечности. Кажется, что разорванное на части создание пытается вновь собраться воедино, и никак не может.",
        ["2x3"] = nil,
        ["3x3"] = nil
    },
    enter = function(s)
...
es.obj {
    ...
    act = function(s)
        if not s.done then
            ...
            return [[После порошка для сухой чистки, разъедающего кожу похлеще кислоты, я не могу нарадоваться настоящей, пусть и отдающей какой-то мерзкой химией воде.
