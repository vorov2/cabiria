...
es.obj {
    nam = "evac",
    dsc = "Можно подумать, что срочно объявили {эвакуацию}, и сотрудники ушли, даже не заблокировав вычислительные аппараты. Алый свет, как в проявочной, лишь усиливает это ощущение.",
