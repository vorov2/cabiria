...
es.room {
    ...
    dsc = function(s)
        if all.lever2.done then
            ...
            return [[Я долго парю под потолком в каюте, собираясь с мыслями. Кровь пульсирует в висках. Прямые линии стен и потолка мреют перед глазами, превращаются в пологие волны. Я и сам плыву в эту обморочную муть, тону в пропитанном едкой химией воздухе.]]
        end
    end,
    preact = function(s)
