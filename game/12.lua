...
es.room {
    ...
    disp = "Коридор",
    dsc = [[Здесь спокойно и тихо, как и должно быть на станции, где уставшие друг от друга люди заперлись в модулях с глухими дверями. Легко представить, что ничего не произошло, и мы на падаем в атмосферу газового гиганта.]],
    onexit = function(s, t)
        if t.nam == "main" then
